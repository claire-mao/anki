...
pub(crate) fn leaf_metrics(
    ...
    let practice_accuracy =
        practice_stats.map(|(correct, total)| correct as f32 / total as f32 * 100.0);
...
pub(crate) fn build_candidate(
    ...
    if let Some((correct, total)) =
        super::signals::practice_stats_for_topic(topic_id, practice_by_topic)
    {
