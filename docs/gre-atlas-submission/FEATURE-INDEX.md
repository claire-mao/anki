...
| Abstention gates (50 cards, 50% coverage, 50 attempts) | `rslib/src/gre_atlas/abstention.rs`             | `abstention.rs`             | `(gre)/ui/GreAbstentionChecklist.svelte`                  | [ARCHITECTURE.md](./ARCHITECTURE.md#score-pipeline), model docs                                                                                          |
